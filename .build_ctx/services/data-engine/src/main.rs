use data_engine::{
    collectors::{PolymarketCollector, TwitterCollector, IBKRCollector, AkShareCollector, MassiveConnector, BinanceConnector, OkxConnector, BybitConnector, FutuConnector},
    ...
    */
    ...
    if let Some(r) = &redis {
        ...
        tokio::spawn(async move {
            ...
            let mut con = client.get_async_connection().await.expect("Failed to connect to Redis PubSub");
