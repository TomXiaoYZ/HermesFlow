...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/v1/jobs/backfill", post(handlers::jobs::trigger_backfill_job))
        .route("/api/v1/agent/monitoring/start", post(handlers::agent::start_agent_monitoring))
...
mod tests {
    ...
    async fn create_test_state() -> AppState {
        ...
        AppState::new(config, None, None, Arc::new(postgres), health_monitor, None, None, tx)
    }
