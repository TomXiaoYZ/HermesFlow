...
impl BybitClient {
    ...
    fn sign_request(&self, timestamp: &str, params: &str) -> Result<String> {
        ...
        let payload = format!("{}{}{}{}", timestamp, self.config.api_key, recv_window, params);
    ...
    pub async fn request<T: DeserializeOwned>(
        ...
        if wrapper.ret_code != 0 {
             return Err(DataError::ExchangeError(format!("Bybit API Error {}: {}", wrapper.ret_code, wrapper.ret_msg)));
        }
