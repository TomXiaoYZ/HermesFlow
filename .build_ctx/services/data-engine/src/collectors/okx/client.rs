...
impl OkxClient {
    ...
    /// Base64 encoded
    fn sign_request(&self, method: &str, path: &str, body: &str, timestamp: &str) -> Result<String> {
    ...
    pub async fn request<T: DeserializeOwned>(
        ...
        if wrapper.code != "0" {
            return Err(DataError::ExchangeError(format!("OKX API Error {}: {}", wrapper.code, wrapper.msg)));
        }
