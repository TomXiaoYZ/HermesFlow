...
impl DexScreenerClient {
    ...
    pub async fn get_token_pairs(&self, token_address: &str) -> Result<Vec<Pair>, Box<dyn Error + Send + Sync>> {
        ...
        let data: DexScreenerResponse = resp.json().await.map_err(|e| Box::new(e) as Box<dyn Error + Send + Sync>)?;
