...
impl SymbolBuffer {
    ...
    fn to_arrays(&self) -> (Array2<f64>, Array2<f64>, Array2<f64>, Array2<f64>, Array2<f64>, Array2<f64>, Array2<f64>) {
...
impl MarketDataManager {
    ...
    pub fn on_update(&mut self, update: MarketDataUpdate) -> Option<Array3<f64>> {
        ...
        let buffer = self.buffers.entry(symbol.clone()).or_insert_with(|| SymbolBuffer::new(symbol));
        buffer.push(&update);
