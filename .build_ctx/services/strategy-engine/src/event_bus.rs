use common::events::{MarketDataUpdate, TradeSignal, StrategyLog};
...
impl EventBus {
    ...
    pub async fn subscribe_market_data(&self, channel_name: &str) -> Result<mpsc::Receiver<MarketDataUpdate>> {
                                ...
                                match msg.get_payload::<String>() {
                                    Ok(payload) => {
                                        match serde_json::from_str::<MarketDataUpdate>(&payload) {
                                            ...
                                            Err(e) => tracing::error!("Failed to deserialize market data: {}", e),
                                        }
                                    },
