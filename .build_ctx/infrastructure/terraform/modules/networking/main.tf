...
# Creates the foundational network infrastructure for HermesFlow
...
# Application Gateway Subnet (reserved for future use)
...
resource "azurerm_network_security_group" "database" {
  ...
  security_rule {
    ...
    source_address_prefix      = "10.0.1.0/24" # From AKS subnet
    destination_address_prefix = "*"
  }
