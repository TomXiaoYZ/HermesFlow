...
impl ATR {
    ...
    /// # Returns
    /// True Range values
    pub fn true_range(high: &Array2<f64>, low: &Array2<f64>, close: &Array2<f64>) -> Array2<f64> {
        ...
        for b in 0..batch_size {
            for t in 0..time_steps {
                tr[[b, t]] = hl[[b, t]].max(hc[[b, t]]).max(lc[[b, t]]);
            }
        }
    ...
    pub fn atr(high: &Array2<f64>, low: &Array2<f64>, close: &Array2<f64>) -> Array2<f64> {
    ...
    pub fn atr_percent(high: &Array2<f64>, low: &Array2<f64>, close: &Array2<f64>) -> Array2<f64> {
